...
#include "UBInfiniteStageGimmick.generated.h"
...
UCLASS()
class UNTILYOUBREAK_API AUBInfiniteStageGimmick : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AUBInfiniteStageGimmick();
...
protected:
	...
	TSubclassOf<class AUBNonPlayerCharacter> OpponentClass;
...
protected:
	...
	TSubclassOf<class AUBItemBox> RewardBoxClass;

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class AUBItemBox>> RewardBoxes;
